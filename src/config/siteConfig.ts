...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "wuduyouou's personal blog",

	// 站点 URL
	site_url: "https://arrangelimit.com",

	// 站点描述
	description:
		"arrangelimit's personal blog, a place to share my thoughts, experiences, and knowledge on various topics.",
